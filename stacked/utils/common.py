...
POPULATION_COST_NUM_PARAMETER_SCALE = 0.01
...
POPULATION_CROSSOVER_COEFFICIENT = 0.95
POPULATION_IMMIGRATION_P = 0.2
POPULATION_CLEANUP_P = 0.8
POPULATION_RANDOM_PICK_P = 0.2
