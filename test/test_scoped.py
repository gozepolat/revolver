...
from stacked.meta.scoped import Scoped, get_elements


class ScopedChild(Scoped):
    def __init__(self, scope, meta, m1, *args, **kwargs):
        super(ScopedChild, self).__init__(scope, meta, *args, **kwargs)
        self.m1 = m1


class ScopedGrandchild(ScopedChild):
    def __init__(self, scope, meta, m1, m2, m3, *args, **kwargs):
        super(ScopedGrandchild, self).__init__(scope, meta, m1, *args, **kwargs)
        self.m2 = m2
        self.m3 = m3


class ScopedGreatGrandchild(ScopedGrandchild):
    def __init__(self, scope, meta, m1, m2, m3, m4, *args, **kwargs):
        super(ScopedGreatGrandchild, self).__init__(scope, meta, m1, m2, m3, *args, **kwargs)
        self.m4 = m4


class TestScopedChildDescendants(TestCase):
    def test_same_types_with_different_scopes(self):
        child1 = ScopedChild('scope1', None, 4)
    ...
    def test_same_types_with_the_same_scope(self):
        child1 = ScopedChild('scope', None, 4)
        child2 = ScopedChild('scope', None, 5)
    ...
    def test_same_grand_types_with_the_same_scope(self):
        child1 = ScopedGrandchild('grand_scope', None, 4, 6, 8)
        child2 = ScopedGrandchild('grand_scope', None, 5, 7, 9)
        self.assertEqual(child1.m1, child2.m1)
    ...
    def test_same_great_grand_types_with_the_same_scope(self):
        child1 = ScopedGreatGrandchild('great_grand_scope', None, 4, 6, 8, 10)
        child2 = ScopedGreatGrandchild('great_grand_scope', None, 5, 7, 9, 11)
        self.assertEqual(child1.m1, child2.m1)
    ...
    def test_different_types_with_the_same_scope(self):
        ScopedGreatGrandchild('5', None, 3, 4, 5, 6)
