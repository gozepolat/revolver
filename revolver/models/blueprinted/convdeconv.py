...
from revolver.models.blueprinted.sequentialunit import SequentialUnit
from revolver.modules.scoped_nn import ScopedConv2d, \
    ScopedConv2dDeconv2dConcat, ScopedConvTranspose2d
from revolver.models.blueprinted.ensemble import ScopedEnsembleConcat
from revolver.models.blueprinted.unit import describe_from_blueprint
...
def log(log_func, msg):
    if common.DEBUG_CONVDECONV:
        log_func("revolver.models.blueprinted.convdeconv: %s" % msg)
